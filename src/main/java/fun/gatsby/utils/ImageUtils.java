...
public class ImageUtils {
	...
	public static void validate(File ori, String dest) throws IOException {
		...
		public static boolean truncateImage (String ori, String dest,int width, int height) throws
		 ...
		 */
		public static boolean truncateImage (String ori, String dest,int x, int y, int width, int height) throws
		IOException, InterruptedException, IM4JavaException {
			File oriFile = new File(ori);
		...
		public static boolean truncateImage (String ori, String dest,int x, int y, int size) throws
		IOException, InterruptedException, IM4JavaException {
